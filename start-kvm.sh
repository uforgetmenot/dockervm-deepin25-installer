...
DISK_IMAGE=${DISK_IMAGE:-/vm-data/deepin25.qcow2}
DISK_SIZE=${DISK_SIZE:-1024G}
INSTALL_ISO=${INSTALL_ISO:-/vm-data/deepin-desktop-community-25.0.1-amd64.iso}
...
QEMU_ARGS=(
    -name guest=deepin25,debug-threads=on
